...
===============================================================================
Lua: VM and compiler for Lua in Go.
===============================================================================

.. image:: https://godoc.org/github.com/edunx/lua?status.svg
    :target: http://godoc.org/github.com/edunx/lua
...
edundx lua fork gopher-lua porject , this a Lua5.1 VM and compiler written in Go. GopherLua has a same goal
...
There are some benchmarks on the `wiki page <https://github.com/edunx/lua/wiki/Benchmarks>`_ .
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc <http://godoc.org/github.com/edunx/lua>`_ for further information.

Note that elements that are not commented in `Go doc <http://godoc.org/github.com/edunx/lua>`_ equivalent to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ , except GopherLua uses objects instead of Lua stack indices.
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc(LState methods) <http://godoc.org/github.com/edunx/lua>`_ for further information.
...
Refer to `Go doc(LState methods) <http://godoc.org/github.com/edunx/lua>`_ for further information.
...
.. code-block:: bash
   ...
   go get github.com/edunx/lua/cmd/glua
...
How to Contribute
----------------------------------------------------------------
See `Guidlines for contributors <https://github.com/edunx/lua/tree/master/.github/CONTRIBUTING.md>`_ .
